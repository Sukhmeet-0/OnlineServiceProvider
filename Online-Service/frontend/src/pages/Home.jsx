                ...
                <div className="container header__container">
                    <div className="header-top-wrp">
                        ...
                        <ul className="link-info">
                            ...
                            <li><a href="#0"><i className="fa-brands fa-youtube"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div className="container header__container">
                    <div className="header__main">
                        ...
                        <div className="main-menu">
                            <nav>
                                <ul>
                                            ...
                                            <li>
                                                <div className="image text-center">
                                                    ...
                                                    <div className="btn__group">
                                                        <a href="index.html" className="btn-one">Multi Page</a>
                                                        <a href="index-one-page.html" className="btn-one mt-2">One Page</a>
                                                    </div>
                                                ...
                                                <div className="image text-center">
                                                    ...
                                                    <div className="btn__group">
                                                        <a href="index-2.html" className="btn-one">Multi Page</a>
                                                        <a href="index-2-one-page.html" className="btn-one mt-2">One Page</a>
                                                    </div>
                                                ...
                                                <div className="image text-center">
                                                    ...
                                                    <div className="btn__group">
                                                        <a href="index-3.html" className="btn-one">Multi Page</a>
                                                        <a href="index-3-one-page.html" className="btn-one mt-2">One Page</a>
                                                    </div>
                                                ...
                                                <div className="image text-center">
                                                    ...
                                                    <div className="btn__group">
                                                        <a href="index-dark.html" className="btn-one">View Page</a>
                                                    </div>
                                    ...
                                    <li className="ml-20 d-none d-lg-block"><a className="search-trigger" href="#0"><svg width="17"
                        ...
                        <div className="d-none d-lg-inline-block">
                            <a href="contact.html" className="btn-one">Get A Quote <i
            ...
            <main>
                ...
                <section className="banner-area">
                    <div className="banner__line">
                        <img className="sway__animation" src="/assets/images/banner/banner-line.png" alt="shape"/>
                    </div>
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                ...
                                <div className="banner__shape-left3 wow slideInLeft">
                                    <img className="sway__animation" src="/assets/images/banner/banner-shape-left.png" alt="shape"/>
                                </div>
                                ...
                                <div className="slide-bg" data-background="assets/images/banner/banner-image.jpg"></div>
                            ...
                            <div className="swiper-slide">
                                ...
                                <div className="slide-bg" data-background="assets/images/banner/banner-image2.jpg"></div>
                                <div className="container">
                                    <div className="banner__content">
                                        <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
                                            className="text-white mb-20">
                            ...
                            <div className="swiper-slide">
                                ...
                                <div className="slide-bg" data-background="assets/images/banner/banner-image3.jpg"></div>
                                <div className="container">
                                    <div className="banner__content">
                                        <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
                                            className="text-white mb-20">
                ...
                <section className="service-area pt-120 pb-120">
                    <div className="service__shape wow slideInRight">
                        <img className="sway_Y__animation" src="/assets/images/shape/service-bg-shape.png" alt="shape"/>
                    </div>
                    <div className="container">
                        ...
                        <div className="row g-4">
                            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                            ...
                            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                            ...
                            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                                <div className="service__item">
                                    <div className="service-shape">
                                        <img src="/assets/images/shape/service-item-shape.png" alt="shape"/>
                                    </div>
                        ...
                        <div className="row g-4">
                                    ...
                                    <div className="image sm-image">
                                        <div className="video__btn-wrp">
                                            <div className="video-btn video-pulse">
                                                <a className="video-popup" href="https://www.youtube.com/watch?v=iVqz_4M5mA0"><i
                            ...
                            <div className="col-xl-6">
                                ...
                                <div className="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <a href="about.html" className="btn-one">Explore More <i
                                        className="fa-regular fa-arrow-right-long"></i></a>
                        ...
                        <div className="counter__wrp gradient-bg">
                            ...
                            <div className="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                                <img src="/assets/images/icon/counter-icon2.png" alt="icon"/>
                                    <div className="content">
                                        <h3><span className="count">600</span>+</h3>
                            ...
                            <div className="counter__item wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                                <img src="/assets/images/icon/counter-icon3.png" alt="icon"/>
                                    <div className="content">
                                        <h3><span className="count">250</span>+</h3>
                                        <p className="text-white">Skilled Experts</p>
                                    </div>
                            </div>
                            <div className="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                                <img src="/assets/images/icon/counter-icon4.png" alt="icon"/>
                                    <div className="content">
                                        <h3><span className="count">590</span>+</h3>
                ...
                <section className="case-area pt-120 pb-120">
                    <div className="container">
                        <div className="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                            ...
                            <a href="case.html" className="btn-one wow fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">view All
                                Case <i className="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <div className="case__item">
                                    ...
                                    <div className="case__content">
                                        ...
                                        <h3><a href="case-details.html" className="text-white primary-hover">IT Management</a></h3>
                                    </div>
                            ...
                            <div className="swiper-slide">
                                <div className="case__item">
                                    ...
                                    <div className="case__content">
                                        ...
                                        <h3><a href="case-details.html" className="text-white primary-hover">Platform
                                            Integration</a></h3>
                                    </div>
                                    <a href="case-details.html" className="case__btn">
                                        <i className="fa-regular fa-arrow-right"></i>
                            ...
                            <div className="swiper-slide">
                                <div className="case__item">
                                    ...
                                    <div className="case__content">
                                        <span className="primary-color sm-font">Solution</span>
                                        <h3><a href="case-details.html" className="text-white primary-hover">Web Development</a>
                                        </h3>
                                    </div>
                                    <a href="case-details.html" className="case__btn">
                                        <i className="fa-regular fa-arrow-right"></i>
                            ...
                            <div className="swiper-slide">
                                <div className="case__item">
                                    ...
                                    <div className="case__content">
                                        ...
                                        <h3><a href="case-details.html" className="text-white primary-hover">Network Security</a>
                                        </h3>
                                    </div>
                                    <a href="case-details.html" className="case__btn">
                                        <i className="fa-regular fa-arrow-right"></i>
                    ...
                    <div className="container">
                        <div className="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-95">
                            <div className="section-header">
                                ...
                                <h2 className="text-white wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Enhance
                                    and Pioneer Using <br/> Technology Trends</h2>
                            </div>
                            <a href="pricing.html" className="btn-one wow fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">Explore
                                More <i className="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                        <div className="row g-4">
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="100ms"
                                data-wow-duration="1500ms">
                                <div className="offer__item">
                                    <div className="shape-top">
                                        <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape"/>
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">
                                <div className="offer__item">
                                    <div className="shape-top">
                                        <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape"/>
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="300ms"
                                data-wow-duration="1500ms">
                                <div className="offer__item">
                                    <div className="shape-top">
                                        <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape"/>
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="400ms"
                                data-wow-duration="1500ms">
                                <div className="offer__item">
                                    <div className="shape-top">
                                        <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape"/>
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="500ms"
                                data-wow-duration="1500ms">
                                <div className="offer__item">
                                    <div className="shape-top">
                                        <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape"/>
                ...
                <section className="testimonial-area bg-image pt-120 pb-120" data-background="assets/images/bg/testimonial-bg.png">
                    <div className="container">
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6 ps-2 ps-lg-5">
                                ...
                                <div className="swiper testimonial__slider wow fadeInDown" data-wow-delay="00ms"
                                    data-wow-duration="1500ms">
                                    <div className="swiper-wrapper">
                                        <div className="swiper-slide">
                                            <div className="testimonial__item">
                                                ...
                                                <p className="mt-30">“ Consectetur adipiscing elit. Integer nunc viverra laoreet est
                                                    the is
                                                    porta pretium
                ...
                <section className="blog-area pt-120 pb-120">
                    <div className="container">
                        ...
                        <div className="row g-4">
                            <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                                data-wow-duration="1500ms">
                                <div className="blog__item">
                                    <a href="blog-details.html" className="blog__image d-block image">
                                    ...
                                    <div className="blog__content">
                                        ...
                                        <h3><a href="blog-details.html" className="primary-hover">Necessity May Give us Best Virtual
                                            Court</a></h3>
                                        <a className="mt-25 read-more-btn" href="blog-details.html">Read More <i
                                            className="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">
                                <div className="blog__item">
                                    <a href="blog-details.html" className="blog__image image d-block">
                                    ...
                                    <div className="blog__content">
                                        ...
                                        <h3><a href="blog-details.html" className="primary-hover">Tackling the Changes of Retail
                                            Industry</a></h3>
                                        <a className="mt-25 read-more-btn" href="blog-details.html">Read More <i
                                            className="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                                ...
                                <div className="blog__item">
                                    ...
                                    <div className="blog__content">
                                        ...
                                        <h3><a href="blog-details.html" className="primary-hover">Easy and Most Powerful Server and
                                            Platform</a>
                                        </h3>
                                        <a className="mt-25 read-more-btn" href="blog-details.html">Read More <i
                                            className="fa-regular fa-arrow-right-long"></i></a>
